{if count($productGroup.features) > 0}
  ...
  <div class="se-footer --mt-10">
    {* se-footer-title *}
    <div class="se-footer-title --text-xl --font-semibold --color-foreground --mb-5">{$LANG.orderForm.includedWithPlans}</div>
    {* row *}
    <div class="row" data-gap-y="15px">
      {foreach $productGroup.features as $features}
        <div class="col-lg-4 col-md-6">
          <!-- line -->
          <div class="line d-flex align-items-center justify-content-start" data-gap-x="10px">
