        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-4 col-md-3 order-sm-2 order-md-last">
                    <button id="btnResendVerificationEmail" class="btn btn-light btn-sm btn-block btn-resend-verify-email btn-action" data-email-sent="{lang key='emailSent'}" data-error-message="{lang key='error'}" data-uri="{routePath('user-email-verification-resend')}">
