<nav class="theme-navbar has-animated-bg float-navbar" id="theme-navbar">
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-content">
      <!-- Logo -->
      <div class="logo-wrapper d-flex align-items-center" data-gap-x="10px">
        <!-- links-toggler -->
      ...
      <div class="links">
        ...
        <div class="close-links">
          <button type="button" class="nt-square --btn-default --btn-sm --radius-full" id="close-links">
      ...
      <div class="actions d-flex align-items-center justify-content-end" data-gap-x="6px">
        {if !$loggedin}
          ...
          <div class="d-md-block d-none">
            <a href="{$WEB_ROOT}/register.php" class="nt-btn --btn-default --wider-btn">{lang key='clientregistertitle'}</a>
          </div>
          {* divider *}
        ...
        <div class="d-flex align-items-center" data-gap-x="6px">
          {if !$loggedin}
            <!-- lang-btn -->
            <button type="button" class="nt-square --btn-ghost" title="Translate" data-toggle="modal" data-target="#modalChooseLanguage">
          ...
          {/if}
          <!-- cart-btn -->
          <a href="{$WEB_ROOT}/cart.php?a=view" class="nt-square --btn-ghost {if $cartitemcount > 0}--has-red-dot{/if}" title="{if $cartitemcount > 0}You have {$cartitemcount} items in your cart {else}{lang key="carttitle"}{/if}">
          ...
          <div class="user-options" id="user_options">
            ...
            <button type="button" class="nt-square --btn-ghost" data-type="user_dropdown_menu_toggler" title="Profile" aria-expanded="false" aria-controls="user_dropdown_menu">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g fill="none">
