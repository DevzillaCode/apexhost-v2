      ...
      <div class="d-flex align-items-center">
        <div class="mr-auto">
          <div class="d-flex align-items-center" data-gap-x="6px">
            {* notifications-btn *}
            <button type="button" class="nt-square --btn-sm --btn-ghost {if count($clientAlerts) > 0} --has-red-dot{/if}" title="{lang key='notifications'}" data-toggle="popover" id="accountNotifications" data-placement="top">
            ...
            <!-- lang-btn -->
            <button type="button" class="nt-square --btn-sm --btn-ghost" title="Translate" data-toggle="modal" data-target="#modalChooseLanguage">
        ...
        <div class="ml-auto">
          ...
          <div class="active-user d-flex align-items-center" data-gap-x="6px">
            ...
            {* btn-group *}
            <div class="d-flex align-items-center" data-gap-x="6px">
              <a href="{$WEB_ROOT}/clientarea.php?action=details" class="nt-btn --btn-sm --btn-ghost">
                <span>
              ...
              <div class="v-divider"></div>
              {* switch-account *}
              <a href="{routePath('user-accounts')}" class="nt-square --btn-sm --btn-ghost" data-toggle="tooltip" data-placement="bottom" title="Switch Account">
              ...
              {if $adminMasqueradingAsClient || $adminLoggedIn}
                <a href="{$WEB_ROOT}/logout.php?returntoadmin=1" class="d-md-none nt-square --btn-sm --btn-ghost" data-toggle="tooltip" data-placement="bottom" title="{if $adminMasqueradingAsClient}{lang key='adminmasqueradingasclient'} {lang key='logoutandreturntoadminarea'}{else}{lang key='adminloggedin'} {lang key='returntoadminarea'}{/if}">
