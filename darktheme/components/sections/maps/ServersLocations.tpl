    ...
    <div class="locations d-flex align-items-center justify-content-center flex-wrap" data-gap-x="45px">
      ...
      <div class="location-item position-relative d-flex align-items-center mb-5" data-gap-x="10px">
        ...
        <div class="location-info d-flex align-items-center" data-gap-x="10px">
          ...
          <p class="server-latency mb-0 d-inline-flex align-items-center text-size-base font-weight-medium color-muted-foreground" data-gap-x="5px">8ms<i class="fas fa-sync-alt text-size-sm"></i></p>
        </div>
      </div>
      {* location-item *}
      <div class="location-item position-relative d-flex align-items-center mb-5" data-gap-x="10px">
        ...
        <div class="location-info d-flex align-items-center" data-gap-x="10px">
          ...
          <p class="server-latency mb-0 d-inline-flex align-items-center text-size-base font-weight-medium color-muted-foreground" data-gap-x="5px">15ms<i class="fas fa-sync-alt text-size-sm"></i></p>
        </div>
      </div>
      {* location-item *}
      <div class="location-item position-relative d-flex align-items-center mb-5" data-gap-x="10px">
        ...
        <div class="location-info d-flex align-items-center" data-gap-x="10px">
          ...
          <p class="server-latency mb-0 d-inline-flex align-items-center text-size-base font-weight-medium color-muted-foreground" data-gap-x="5px">35ms<i class="fas fa-sync-alt text-size-sm"></i></p>
        </div>
      </div>
      {* location-item *}
      <div class="location-item position-relative d-flex align-items-center mb-5" data-gap-x="10px">
        ...
        <div class="location-info d-flex align-items-center" data-gap-x="10px">
          ...
          <p class="server-latency mb-0 d-inline-flex align-items-center text-size-base font-weight-medium color-muted-foreground" data-gap-x="5px">20ms<i class="fas fa-sync-alt text-size-sm"></i></p>
        </div>
      </div>
      {* location-item *}
      <div class="location-item position-relative d-flex align-items-center mb-5" data-gap-x="10px">
        ...
        <div class="location-info d-flex align-items-center" data-gap-x="10px">
          ...
          <p class="server-latency mb-0 d-inline-flex align-items-center text-size-base font-weight-medium color-muted-foreground" data-gap-x="5px">45ms<i class="fas fa-sync-alt text-size-sm"></i></p>
        </div>
      </div>
    </div>
    {* locations-map *}
