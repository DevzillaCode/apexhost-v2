<div class="container-fluid py-5">
  ...
  <div class="d-flex align-items-center justify-content-start mt-4" data-gap-x="10px">
    ...
    <button class="nt-btn nt-btn-secondary nt-btn-size-sm">Click</button>
    <button class="nt-btn nt-btn-success nt-btn-size-sm">Click</button>
    <button class="nt-btn nt-btn-danger nt-btn-size-sm">Click</button>
    <button class="nt-btn nt-btn-warning nt-btn-size-sm">Click</button>
    <button class="nt-btn nt-btn-info nt-btn-size-sm">Click</button>
    <button class="nt-btn nt-btn-default nt-btn-size-sm">Click</button>
    <button class="nt-btn nt-btn-dark nt-btn-size-sm">Click</button>
  ...
  <div class="d-flex align-items-center justify-content-start mt-4" data-gap-x="10px">
    ...
    <button class="nt-btn nt-btn-outline-success">Click</button>
    <button class="nt-btn nt-btn-outline-danger">Click</button>
    <button class="nt-btn nt-btn-outline-warning">Click</button>
    <button class="nt-btn nt-btn-outline-info">Click</button>
  ...
  <div class="d-flex align-items-center justify-content-start mt-4" data-gap-x="10px">
    ...
    <button class="nt-btn nt-btn-secondary nt-btn-size-lg">Click</button>
    <button class="nt-btn nt-btn-success nt-btn-size-lg">Click</button>
    <button class="nt-btn nt-btn-danger nt-btn-size-lg">Click</button>
    <button class="nt-btn nt-btn-warning nt-btn-size-lg">Click</button>
    <button class="nt-btn nt-btn-info nt-btn-size-lg">Click</button>
    <button class="nt-btn nt-btn-default nt-btn-size-lg">Click</button>
    <button class="nt-btn nt-btn-dark nt-btn-size-lg">Click</button>
