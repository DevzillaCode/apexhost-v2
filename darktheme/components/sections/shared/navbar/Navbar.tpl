    ...
    <div class="navbar-content">
      ...
      <div class="links">
        ...
        <div class="close-links">
          <button type="button" class="btn-square btn-light btn-circle btn-sm" id="close-links">
      ...
      <div class="actions d-flex align-items-center justify-content-end" data-gap-x="6px">
        ...
        <div class="d-flex align-items-center" data-gap-x="6px">
          ...
          {/if}
          <!-- cart-btn -->
          <a href="{$WEB_ROOT}/cart.php?a=view" class="btn-square btn-ghost-light btn-sm {if $cartitemcount > 0}nt-has-red-dot{/if}" title="{if $cartitemcount > 0}You have {$cartitemcount} items in your cart {else}{lang key="carttitle"}{/if}">
          ...
          <div class="user-options" id="user_options">
            ...
            <button type="button" class="btn-square btn-ghost-light btn-sm" data-type="user_dropdown_menu_toggler" title="Profile" aria-expanded="false" aria-controls="user_dropdown_menu">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <g fill="none">
