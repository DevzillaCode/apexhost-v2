      ...
      <div class="d-flex align-items-center justify-content-between" data-gap-x="6px">
        ...
        <div class="left-content" id="float-bar-left-content">
          <div class="d-flex align-items-center" data-gap-x="6px">
            <button type="button" class="nt-btn --btn-glass --btn-sm --radius-pill active" id="float-bar-domain-btn">
            ...
            <button type="button" class="nt-btn --btn-glass --btn-sm --radius-pill" id="float-bar-knowledgebase-btn">
            ...
            <button type="button" class="nt-btn --btn-glass --btn-sm --radius-pill" id="float-bar-downloads-btn">
              <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 24 24">
        ...
        <div class="right-content d-flex align-items-center" data-gap-x="6px">
          <button type="submit" class="nt-btn --btn-glass --btn-sm --radius-pill --icon-size-14" id="float-search-btn">
            <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 1000 1000">
              <path fill="currentColor" d="m746 641l254 255l-105 105l-254-254q-106 72-232 72q-169 0-289-120T0 410t120-289T409 1t289 120t120 289q0 127-72 231zm-65-231q0-113-79.5-193T409 137t-193 80t-80 193t80 192.5T409 682t192.5-79.5T681 410z" />
            </svg>
            Search
          ...
          {* toggler *}
          <button type="button" class="nt-square --btn-glass --btn-sm --radius-pill" id="float-bar-toggler">
            <svg class="_expand_icon" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 20 20">
              <g fill="currentColor">
            ...
            <svg class="_collapse_icon" xmlns="http://www.w3.org/2000/svg" width="200" height="200" viewBox="0 0 16 16">
