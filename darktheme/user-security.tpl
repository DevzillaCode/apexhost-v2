  ...
  <div class="card">
    <div class="card-body">
      ...
      <div class="d-flex col-gap-2 mt-4">
        <a href="{routePath('account-security-two-factor-disable')}" class="btn btn-semi-ghost-danger btn-sm open-modal twofa-config-link disable{if !$twoFactorAuthEnabled} w-hidden{/if}" data-modal-title="{lang key='twofadisable'}" data-modal-class="twofa-setup" data-btn-submit-label="{lang key='twofadisable'}" data-btn-submit-color="danger" data-btn-submit-id="btnDisable2FA">
          {lang key='twofadisableclickhere'}
        </a>
        <a href="{routePath('account-security-two-factor-enable')}" class="btn btn-semi-ghost-success btn-sm open-modal twofa-config-link enable{if $twoFactorAuthEnabled} w-hidden{/if}" data-modal-title="{lang key='twofaenable'}" data-modal-class="twofa-setup" data-btn-submit-id="btnEnable2FA">
