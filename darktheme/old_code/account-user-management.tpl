        ...
        <table class="table table-striped">
            ...
            {foreach $users as $user}
                <tr>
                    ...
                    <td>
                        <a href="{routePath('account-users-permissions', $user->id)}" class="btn btn-light btn-sm btn-manage-permissions{if $user->pivot->owner} disabled{/if}">
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="{routePath('account-users-invite-resend')}">
                                ...
                                <button type="button" class="btn btn-light btn-sm btn-cancel-invite" data-id="{$invite->id}">
