                        ...
                        <div class="invite-box">
                            ...
                            <form method="post" action="{routePath('login-validate')}" class="text-left">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-light{$captcha->getButtonClass($captchaForm)}">
                                        {lang key="login"}
                                    </button>
                                </div>
                            </form>
                    ...
                    <div class="col-lg-6">
                        <div class="invite-box">
                            ...
                            <form method="post" action="{routePath('invite-validate', $invite->token)}" class="text-left">
                                ...
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" class="btn btn-light generate-password" data-targetfields="inputPassword">
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-light{$captcha->getButtonClass($captchaFormRegister)}">
                                        {lang key="register"}
                                    </button>
                                </div>
                            </form>
