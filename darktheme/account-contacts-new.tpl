      ...
      <div class="col-md-6 d-flex flex-column row-gap-4">
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="text" name="firstname" id="inputFirstName" value="{$formdata.firstname}" class="form-control" autocomplete="off" placeholder="{lang key='clientareafirstname'}" />
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="text" name="lastname" id="inputLastName" value="{$formdata.lastname}" class="form-control" autocomplete="off" placeholder="{lang key='clientarealastname'}" />
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="text" name="companyname" id="inputCompanyName" value="{$formdata.companyname}" class="form-control" autocomplete="off" placeholder="{lang key='clientareacompanyname'}" />
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="email" name="email" id="inputEmail" value="{$formdata.email}" class="form-control" autocomplete="off" placeholder="{lang key='clientareaemail'}" />
          </div>
        </div>
        <div class="form-group">
        ...
        {if $showTaxIdField}
          <div class="form-group">
            ...
            <div class="prepend-icon">
              ...
              {* form-control *}
              <input type="text" name="tax_id" id="inputTaxId" class="form-control" value="{$formdata.tax_id}" autocomplete="off" placeholder="{lang key=$taxIdLabel}" />
            </div>
          </div>
        {/if}
      </div>
      ...
      <div class="col-md-6 col-12 d-flex flex-column row-gap-4">
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="text" name="address1" id="inputAddress1" value="{$formdata.address1}" class="form-control" autocomplete="off" placeholder="{lang key='clientareaaddress1'}" />
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="text" name="address2" id="inputAddress2" value="{$formdata.address2}" class="form-control" autocomplete="off" placeholder="{lang key='clientareaaddress2'}" />
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="text" name="city" id="inputCity" value="{$formdata.city}" class="form-control" autocomplete="off" placeholder="{lang key='clientareacity'}" />
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="text" name="state" id="inputState" value="{$formdata.state}" class="form-control" autocomplete="off" placeholder="{lang key='clientareastate'}" />
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="prepend-icon">
            ...
            {* form-control *}
            <input type="text" name="postcode" id="inputPostcode" value="{$formdata.postcode}" class="form-control" autocomplete="off" placeholder="{lang key='clientareapostcode'}" />
          </div>
        </div>
        <div class="form-group">
