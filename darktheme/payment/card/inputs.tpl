<div{if !$addingNewCard} class="w-hidden"{/if}>
    <div class="form-group cc-details row">
        <label for="inputCardNumber" class="col-sm-4 text-md-right form-label">{lang key='creditcardcardnumber'}</label>
        <div class="col-sm-7">
    ...
    {if $showccissuestart}
        <div class="form-group cc-details row">
            <label for="inputCardStart" class="col-sm-4 text-md-right form-label">{lang key='creditcardcardstart'}</label>
            <div class="col-sm-8">
    ...
    {/if}
    <div class="form-group cc-details row">
        <label for="inputCardExpiry" class="col-sm-4 text-md-right form-label">{lang key='creditcardcardexpires'}</label>
        <div class="col-sm-8">
    ...
    {if $showccissuestart}
        <div class="form-group row cc-details">
            <label for="inputIssueNum" class="col-sm-4 text-md-right form-label">{lang key='creditcardcardissuenum'}</label>
            <div class="col-2">
...
<div class="form-group row">
    <label for="inputCardCvv" class="col-sm-4 text-md-right form-label">{lang key='creditcardcvvnumber'}</label>
    <div class="col-sm-7">
...
<div{if !$addingNewCard} class="w-hidden"{/if}>
    <div id="inputDescriptionContainer" class="form-group cc-details row">
        <label for="inputDescription" class="col-sm-4 text-md-right form-label">{lang key='paymentMethods.cardDescription'}</label>
        <div class="col-sm-6">
