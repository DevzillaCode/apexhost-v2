    ...
    <div class="card-body">
        ...
        <div class="btn-toolbar justify-content-between mb-1" role="toolbar">
            ...
            <div class="btn-group btn-group-sm" role="group">
                ...
                <button id="btnRefresh" type="button" class="btn btn-sm btn-light disabled" disabled="disabled">
        ...
        <table class="ox-table-accounts table" style="display: table">
            ...
            <tr class="cloneAliasRow w-hidden" data-alias="">
                ...
                <td class="text-right">
                    <div class="btn-group" role="group">
                        <button class="btn btn-light btn-xs ox-delete-alias">{lang key='ox.delete'}</button>
                    </div>
                </td>
            </tr>
        </table>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append">
                                        <button type="button" class="btn btn-light generate-password" data-targetfields="inputPassword,inputConfirmPassword">
                ...
                <div class="modal-body card-body" id="modalSetPasswordBody">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="btn btn-light generate-password" data-targetfields="inputChangePassword,inputChangePasswordConfirm">
                                    {lang key="generatePassword.btnShort"}
                                </button>
                            </div>
                        </div>
